...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Data Expert </li>
            </ol>
        </div>
    ...
    <div class="row">
        ...
        <div class="card col-md-12">
            ...
            @endif
            <div class="card-body">
                <h4 class="card-title">Daftar Expert</h4>
                
                <a href="{{ url('/expert/create')}}"><button class="btn btn-primary pull-right">Tambah
                        Data</button></a>
                ...
                <div class="table-responsive m-t-40">
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no+1 }}</td>
                                <td><img src="{{ url('/').'/'. $dt->photo }}" height="100" alt="" srcset=""></td>
                                <td>{{ $dt->name }}</td>
                                <td>{{ $dt->phone }}</td>
                                <td>
                                    <a href="{{ url('/expert/'.$dt->id.'/edit') }}" class="btn btn-info"><i
                                            class="mdi mdi-pencil"></i>Edit</a>
                                    <a href="#" data-id="{{ $dt->id }}" class="btn btn-danger sa-params"><i
                                            class="fa fa-trash-o">
                                            <form action="{{ route('expert.destroy', $dt->id) }}"
