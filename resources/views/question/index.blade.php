    ...
    <div class="row">
        ...
        <div class="card col-md-12">
            ...
            <div class="card-body">
                ...
                <a href="{{ url('/kuesioner/create')}}"><button class="btn btn-primary pull-right">Tambah
                        Data</button></a>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $dt->score }}</td>
                                <td>
                                    <a href="{{ url('/kuesioner/'.$dt->id.'/edit') }}" class="btn btn-info"><i
                                            class="mdi mdi-pencil"></i>Edit</a>
                                    <a href="#" data-id="{{ $dt->id }}" class="btn btn-danger sa-params"><i
                                            class="fa fa-trash-o">
                                            <form action="{{ route('kuesioner.destroy', $dt->id) }}"
